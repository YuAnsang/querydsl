...
import com.github.asyu.querydsl.dto.MemberDto;
import com.github.asyu.querydsl.dto.QMemberDto;
import com.github.asyu.querydsl.dto.UserDto;
...
//		List<Member> content = results.getResults();
	...
	public void findDtoByJPQL() {
		List<MemberDto> result = em.createQuery("select new com.github.asyu.querydsl.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class).getResultList();
